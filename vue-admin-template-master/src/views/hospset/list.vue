<template>
  <div class="app-container">
    ...
    <!-- layout：布局   current-change：每次发生页数的变化，该事件就会触发（该函数是模板该封装的） -->
  </div>
</template>
...
// import hospset from '../../api/hospset' 这句也等价于import hospset from '@/api/hospset' ‘@’符号是vue的特性;
